...
<section id="userLogin">
    <div class="container mb-5 d-flex flex-column align-item-center justify-content-center">
        <div class="row d-flex p-4 align-item-center justify-content-center">
            ...
            <form class="col-12 col-md-4 text-center" action="/controllers/user/user-boardCtrl.php" method="post">
                <input class="form-control form-control-lg mb-3 text-center" type="mail" name="userLogin" id="userLogin" placeholder="Adresse mail">
                <input class="form-control form-control-lg mb-3 text-center" type="password" name="userPassword" id="userPassword" placeholder="Mot de passe">
