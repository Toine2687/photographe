...
<footer>
    ...
    <div id="legalDiv">
        <ul>
            ...
            <li class="legalLinks"><a href="">Mentions légales</a></li>
            <li class="legalLinks"><a href="">Cookies</a></li>
            <li class="legalLinks">Conditions générales d'utilisation</li>
            <li class="legalLinks">SIRET 512375502</li>
